...
export default function PageTab() {
  ...
  return (
    <div className="sticky left-0 top-0 hidden w-full border-b border-border bg-black-300 text-sm md:block">
      <div className="flex w-max items-center gap-2 border-r border-t border-border border-t-primary bg-black-200 px-3 py-2">
        <IoLogoJavascript className=" text-yellow-400 dark:text-yellow-300" />
